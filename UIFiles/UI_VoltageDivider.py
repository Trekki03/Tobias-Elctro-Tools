...
class Ui_VoltageDivider(object):
    ...
    def retranslateUi(self, VoltageDivider):
        ...
        self.leUdU.setInputMask(QCoreApplication.translate("VoltageDivider", u"9999999999", None))
        self.leUdU.setText("")
        self.leUdR1.setInputMask(QCoreApplication.translate("VoltageDivider", u"9999999999", None))
        self.leUdR1.setText("")
        self.leUdR2.setInputMask(QCoreApplication.translate("VoltageDivider", u"9999999999", None))
        self.leR2U.setInputMask(QCoreApplication.translate("VoltageDivider", u"9999999999", None))
        self.leR2R1.setInputMask(QCoreApplication.translate("VoltageDivider", u"9999999999", None))
        self.leR2Ud.setInputMask(QCoreApplication.translate("VoltageDivider", u"9999999999", None))
    # retranslateUi
